...
public class DaichulibaoxiuActivity extends BaseActity
        implements InfoRepairView
{
    ...
    public void getBaoxiuitembean(Baoxiuitembean paramBaoxiuitembean)
    {
        if (paramBaoxiuitembean.isSuccess())
        {
            ...
            this.hfr.setText(paramBaoxiuitembean.getReplyUser());
            this.hfsj.setText(paramBaoxiuitembean.getReplyTime());
            this.hfnr.setText(paramBaoxiuitembean.getReplyContent());
    ...
    public void initview()
    {
        ...
        this.button.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                DaichulibaoxiuActivity.this.finish();
            }
        });
